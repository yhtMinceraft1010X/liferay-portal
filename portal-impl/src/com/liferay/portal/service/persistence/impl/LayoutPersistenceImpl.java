...
public class LayoutPersistenceImpl
	...
	public Layout fetchByG_P_P_S_Last(
		...
		int count = countByG_P_P_S(groupId, privateLayout, parentLayoutId);
	...
	public int filterCountByG_P_P_S(
		...
		if (!InlineSQLHelperUtil.isEnabled(groupId)) {
			return countByG_P_P_S(groupId, privateLayout, parentLayoutId);
		}
	...
	public int filterCountByG_P_P_S(
		...
		if (!InlineSQLHelperUtil.isEnabled(groupId)) {
			return countByG_P_P_S(groupId, privateLayout, parentLayoutIds);
		}
