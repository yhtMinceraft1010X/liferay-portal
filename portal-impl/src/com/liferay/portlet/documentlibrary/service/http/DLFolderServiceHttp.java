...
public class DLFolderServiceHttp {
	...
	public static java.util.List
		...
		try {
			MethodKey methodKey = new MethodKey(
				...
				_getMountFoldersParameterTypes23);
	...
	public static int getMountFoldersCount(
		...
		try {
			MethodKey methodKey = new MethodKey(
				...
				_getMountFoldersCountParameterTypes24);
	...
	public static boolean hasFolderLock(
		...
		try {
			MethodKey methodKey = new MethodKey(
				...
				_hasFolderLockParameterTypes27);
	...
	public static boolean hasInheritableLock(
		...
		try {
			MethodKey methodKey = new MethodKey(
				...
				_hasInheritableLockParameterTypes28);
	...
	public static boolean isFolderLocked(
		...
		try {
			MethodKey methodKey = new MethodKey(
				...
				_isFolderLockedParameterTypes29);
	...
	public static com.liferay.portal.kernel.lock.Lock refreshFolderLock(
		...
		try {
			MethodKey methodKey = new MethodKey(
				...
				_refreshFolderLockParameterTypes33);
	...
	public static boolean verifyInheritableLock(
		...
		try {
			MethodKey methodKey = new MethodKey(
				...
				_verifyInheritableLockParameterTypes38);
	...
	private static final Class<?>[] _getMountFoldersParameterTypes23 =
		new Class[] {
			long.class, long.class, int.class, int.class,
			com.liferay.portal.kernel.util.OrderByComparator.class
		};
	private static final Class<?>[] _getMountFoldersCountParameterTypes24 =
		new Class[] {long.class, long.class};
	...
	private static final Class<?>[] _hasFolderLockParameterTypes27 =
		new Class[] {long.class};
	private static final Class<?>[] _hasInheritableLockParameterTypes28 =
		new Class[] {long.class};
	private static final Class<?>[] _isFolderLockedParameterTypes29 =
		new Class[] {long.class};
	...
	private static final Class<?>[] _refreshFolderLockParameterTypes33 =
	...
	private static final Class<?>[] _verifyInheritableLockParameterTypes38 =
		new Class[] {long.class, String.class};
