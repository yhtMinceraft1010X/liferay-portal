...
/**
 * The arguments resolver class for retrieving value from SocialActivitySetting.
 *
 * @author Brian Wing Shun Chan
 * @generated
 */
public class SocialActivitySettingModelArgumentsResolver
	...
	public Object[] getArguments(
		...
		long columnBitmask = socialActivitySettingModelImpl.getColumnBitmask();
		...
		if (finderPathColumnBitmask == null) {
			...
			for (String columnName : columnNames) {
				finderPathColumnBitmask |=
					socialActivitySettingModelImpl.getColumnBitmask(columnName);
			}
