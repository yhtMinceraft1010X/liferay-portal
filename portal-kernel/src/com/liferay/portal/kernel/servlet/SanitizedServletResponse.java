...
public class SanitizedServletResponse extends HttpServletResponseWrapper {
	...
	public void addHeader(String name, String value) {
		super.addHeader(
			HttpHelperUtil.sanitizeHeader(name),
			HttpHelperUtil.sanitizeHeader(value));
	}

	@Override
	public void sendRedirect(String location) throws IOException {
		super.sendRedirect(HttpHelperUtil.sanitizeHeader(location));
	}

	@Override
	public void setCharacterEncoding(String charset) {
		super.setCharacterEncoding(HttpHelperUtil.sanitizeHeader(charset));
	}

	@Override
	public void setContentType(String contentType) {
		super.setContentType(HttpHelperUtil.sanitizeHeader(contentType));
	}
