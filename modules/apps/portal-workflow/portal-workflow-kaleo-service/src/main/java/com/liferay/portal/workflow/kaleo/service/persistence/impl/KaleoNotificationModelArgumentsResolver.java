...
/**
 * The arguments resolver class for retrieving value from KaleoNotification.
 *
...
@Component(
	immediate = true,
	service = {
		KaleoNotificationModelArgumentsResolver.class, ArgumentsResolver.class
	}
)
public class KaleoNotificationModelArgumentsResolver
	...
	public Object[] getArguments(
		...
		if (finderPathColumnBitmask == null) {
			...
			if (finderPath.isBaseModelResult() &&
				(KaleoNotificationPersistenceImpl.
