...
public class FVSCustomEntryUtil {
	 ...
	 * @throws NoSuchCustomEntryException if a matching fvs custom entry could not be found
	 */
	public static FVSCustomEntry findByU_EI_N(
			long userId, String entityId, String name)
		throws com.liferay.frontend.view.state.exception.
			NoSuchCustomEntryException {

		return getPersistence().findByU_EI_N(userId, entityId, name);
	}
	 ...
	 */
	public static FVSCustomEntry fetchByU_EI_N(
		long userId, String entityId, String name) {

		return getPersistence().fetchByU_EI_N(userId, entityId, name);
	}
	...
	public static FVSCustomEntry fetchByU_EI_N(
		...
		return getPersistence().fetchByU_EI_N(
			userId, entityId, name, useFinderCache);
	}
	 ...
	 */
	public static FVSCustomEntry removeByU_EI_N(
			long userId, String entityId, String name)
		throws com.liferay.frontend.view.state.exception.
			NoSuchCustomEntryException {

		return getPersistence().removeByU_EI_N(userId, entityId, name);
	}
	 ...
	 * @return the number of matching fvs custom entries
	 */
	public static int countByU_EI_N(long userId, String entityId, String name) {
		return getPersistence().countByU_EI_N(userId, entityId, name);
	}
