...
/**
 * The arguments resolver class for retrieving value from FVSEntry.
 *
...
@Component(
	immediate = true,
	service = {FVSEntryModelArgumentsResolver.class, ArgumentsResolver.class}
)
public class FVSEntryModelArgumentsResolver implements ArgumentsResolver {
	...
	public Object[] getArguments(
		...
		if (finderPathColumnBitmask == null) {
			...
			for (String columnName : columnNames) {
				finderPathColumnBitmask |= fvsEntryModelImpl.getColumnBitmask(
					columnName);
			}
