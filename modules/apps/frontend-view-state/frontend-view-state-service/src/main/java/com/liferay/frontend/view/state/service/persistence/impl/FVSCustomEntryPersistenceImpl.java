...
public class FVSCustomEntryPersistenceImpl
	...
	private FinderPath _finderPathFetchByU_EI_N;
	private FinderPath _finderPathCountByU_EI_N;
	...
	public FVSCustomEntry findByU_EI_N(
		...
		FVSCustomEntry fvsCustomEntry = fetchByU_EI_N(userId, entityId, name);
	...
	public FVSCustomEntry fetchByU_EI_N(
		...
		return fetchByU_EI_N(userId, entityId, name, true);
	}
	...
	public FVSCustomEntry fetchByU_EI_N(
		...
		if (useFinderCache) {
			finderArgs = new Object[] {userId, entityId, name};
		}
		...
		if (useFinderCache) {
			result = finderCache.getResult(
				_finderPathFetchByU_EI_N, finderArgs);
		}

		if (result instanceof FVSCustomEntry) {
			FVSCustomEntry fvsCustomEntry = (FVSCustomEntry)result;

			if ((userId != fvsCustomEntry.getUserId()) ||
				!Objects.equals(entityId, fvsCustomEntry.getEntityId()) ||
				!Objects.equals(name, fvsCustomEntry.getName())) {
		...
		if (result == null) {
			...
			sb.append(_FINDER_COLUMN_U_EI_N_USERID_2);

			boolean bindEntityId = false;

			if (entityId.isEmpty()) {
				sb.append(_FINDER_COLUMN_U_EI_N_ENTITYID_3);
			}
			else {
				bindEntityId = true;

				sb.append(_FINDER_COLUMN_U_EI_N_ENTITYID_2);
			}

			boolean bindName = false;

			if (name.isEmpty()) {
				sb.append(_FINDER_COLUMN_U_EI_N_NAME_3);
			}
			else {
				bindName = true;

				sb.append(_FINDER_COLUMN_U_EI_N_NAME_2);
			}
				...
				if (list.isEmpty()) {
					if (useFinderCache) {
						finderCache.putResult(
							_finderPathFetchByU_EI_N, finderArgs, list);
					}
				}
				else {
					FVSCustomEntry fvsCustomEntry = list.get(0);

					result = fvsCustomEntry;
	...
	public FVSCustomEntry removeByU_EI_N(
		...
		FVSCustomEntry fvsCustomEntry = findByU_EI_N(userId, entityId, name);
	...
	public int countByU_EI_N(long userId, String entityId, String name) {
		...
		FinderPath finderPath = _finderPathCountByU_EI_N;

		Object[] finderArgs = new Object[] {userId, entityId, name};
	...
	private static final String _FINDER_COLUMN_U_EI_N_USERID_2 =
		"fvsCustomEntry.userId = ? AND ";

	private static final String _FINDER_COLUMN_U_EI_N_ENTITYID_2 =
		"fvsCustomEntry.entityId = ? AND ";

	private static final String _FINDER_COLUMN_U_EI_N_ENTITYID_3 =
		"(fvsCustomEntry.entityId IS NULL OR fvsCustomEntry.entityId = '') AND ";

	private static final String _FINDER_COLUMN_U_EI_N_NAME_2 =
		"fvsCustomEntry.name = ?";

	private static final String _FINDER_COLUMN_U_EI_N_NAME_3 =
		"(fvsCustomEntry.name IS NULL OR fvsCustomEntry.name = '')";
	...
	public void cacheResult(FVSCustomEntry fvsCustomEntry) {
		...
		finderCache.putResult(
			_finderPathFetchByU_EI_N,
			new Object[] {
				fvsCustomEntry.getUserId(), fvsCustomEntry.getEntityId(),
	...
	protected void cacheUniqueFindersCache(
		...
		Object[] args = new Object[] {
			fvsCustomEntryModelImpl.getUserId(),
			fvsCustomEntryModelImpl.getEntityId(),
			fvsCustomEntryModelImpl.getName()
		};

		finderCache.putResult(_finderPathCountByU_EI_N, args, Long.valueOf(1));
		finderCache.putResult(
			_finderPathFetchByU_EI_N, args, fvsCustomEntryModelImpl);
	}
	...
	public FVSCustomEntry updateImpl(FVSCustomEntry fvsCustomEntry) {
		...
		cacheUniqueFindersCache(fvsCustomEntryModelImpl);
	...
	public void activate(BundleContext bundleContext) {
		...
		_argumentsResolverServiceRegistration = _bundleContext.registerService(
			ArgumentsResolver.class, new FVSCustomEntryModelArgumentsResolver(),
		...
		_finderPathFetchByU_EI_N = new FinderPath(
			FINDER_CLASS_NAME_ENTITY, "fetchByU_EI_N",
			new String[] {
				Long.class.getName(), String.class.getName(),
				String.class.getName()
			},
			new String[] {"userId", "entityId", "name"}, true);

		_finderPathCountByU_EI_N = new FinderPath(
			FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION, "countByU_EI_N",
			new String[] {
				Long.class.getName(), String.class.getName(),
				String.class.getName()
			},
			new String[] {"userId", "entityId", "name"}, false);
	}
	...
	private static class FVSCustomEntryModelArgumentsResolver
		...
		public Object[] getArguments(
			...
			if (!checkColumn || (columnBitmask == 0)) {
				return _getValue(
					fvsCustomEntryModelImpl, columnNames, original);
			}
		...
		private static Object[] _getValue(
			...
			for (int i = 0; i < arguments.length; i++) {
				...
				if (original) {
					arguments[i] =
						fvsCustomEntryModelImpl.getColumnOriginalValue(
							columnName);
				}
				else {
