...
create unique index IX_335B7FE0 on CommercePriceModifier (companyId, externalReferenceCode[$COLUMN_LENGTH:75$]);
...
create unique index IX_FCABA3C8 on CommercePricingClass (companyId, externalReferenceCode[$COLUMN_LENGTH:75$]);
