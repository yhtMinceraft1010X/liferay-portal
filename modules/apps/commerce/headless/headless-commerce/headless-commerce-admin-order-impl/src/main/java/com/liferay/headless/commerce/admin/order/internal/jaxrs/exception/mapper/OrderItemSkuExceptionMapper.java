...
@Component(
	...
	property = {
		...
		"osgi.jaxrs.name=Liferay.Headless.Commerce.Admin.Order.OrderItemSkuExceptionExceptionMapper"
	},
	service = ExceptionMapper.class
)
@Provider
public class OrderItemSkuExceptionMapper
	extends BaseExceptionMapper<CPInstanceSkuException> {

	@Override
	public String getErrorDescription() {
		return "Invalid order item sku";
	}
