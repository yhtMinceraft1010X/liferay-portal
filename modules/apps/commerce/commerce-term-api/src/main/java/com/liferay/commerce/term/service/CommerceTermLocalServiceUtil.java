...
/**
 * Provides the local service utility for CommerceTerm. This utility wraps
 * <code>com.liferay.commerce.term.service.impl.CommerceTermLocalServiceImpl</code> and
 ...
 * @generated
 */
public class CommerceTermLocalServiceUtil {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this class directly. Add custom service methods to <code>com.liferay.commerce.term.service.impl.CommerceTermLocalServiceImpl</code> and rerun ServiceBuilder to regenerate this class.
	 */
	 ...
	 */
	public static CommerceTerm addCommerceTerm(CommerceTerm commerceTerm) {
		return getService().addCommerceTerm(commerceTerm);
	}
	 ...
	 */
	public static CommerceTerm createCommerceTerm(long commerceTermId) {
		return getService().createCommerceTerm(commerceTermId);
	}
	 ...
	 */
	public static CommerceTerm deleteCommerceTerm(CommerceTerm commerceTerm) {
		return getService().deleteCommerceTerm(commerceTerm);
	}
	 ...
	 */
	public static CommerceTerm deleteCommerceTerm(long commerceTermId)
		throws PortalException {

		return getService().deleteCommerceTerm(commerceTermId);
	}
	...
	public static CommerceTerm fetchCommerceTerm(long commerceTermId) {
		return getService().fetchCommerceTerm(commerceTermId);
	}
	 ...
	 */
	public static CommerceTerm fetchCommerceTermByExternalReferenceCode(
		long companyId, String externalReferenceCode) {

		return getService().fetchCommerceTermByExternalReferenceCode(
	 ...
	 */
	@Deprecated
	public static CommerceTerm fetchCommerceTermByReferenceCode(
		long companyId, String externalReferenceCode) {

		return getService().fetchCommerceTermByReferenceCode(
			companyId, externalReferenceCode);
	}
	 ...
	 * @throws PortalException if a commerce term with the primary key could not be found
	 */
	public static CommerceTerm getCommerceTerm(long commerceTermId)
		throws PortalException {

		return getService().getCommerceTerm(commerceTermId);
	}
	 ...
	 */
	public static CommerceTerm getCommerceTermByExternalReferenceCode(
			long companyId, String externalReferenceCode)
		throws PortalException {

		return getService().getCommerceTermByExternalReferenceCode(
			companyId, externalReferenceCode);
	}
	 ...
	 */
	public static List<CommerceTerm> getCommerceTerms(int start, int end) {
		return getService().getCommerceTerms(start, end);
	}
	 ...
	 */
	public static int getCommerceTermsCount() {
		return getService().getCommerceTermsCount();
	}
	 ...
	 */
	public static CommerceTerm updateCommerceTerm(CommerceTerm commerceTerm) {
		return getService().updateCommerceTerm(commerceTerm);
	}

	public static CommerceTermLocalService getService() {
		return _service;
	}

	private static volatile CommerceTermLocalService _service;
