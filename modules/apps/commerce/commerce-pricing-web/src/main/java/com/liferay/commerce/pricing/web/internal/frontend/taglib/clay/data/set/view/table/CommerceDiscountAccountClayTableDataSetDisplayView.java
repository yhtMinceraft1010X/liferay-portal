...
@Component(
	...
	property = "clay.data.set.display.name=" + CommercePricingDataSetConstants.COMMERCE_DATA_SET_KEY_DISCOUNT_QUALIFIER_ACCOUNTS,
	service = ClayDataSetDisplayView.class
)
public class CommerceDiscountAccountClayTableDataSetDisplayView
