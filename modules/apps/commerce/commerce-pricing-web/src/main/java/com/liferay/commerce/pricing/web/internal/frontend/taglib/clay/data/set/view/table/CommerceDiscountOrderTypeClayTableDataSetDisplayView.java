...
@Component(
	...
	property = "clay.data.set.display.name=" + CommercePricingDataSetConstants.COMMERCE_DATA_SET_KEY_DISCOUNT_QUALIFIER_ORDER_TYPES,
	service = ClayDataSetDisplayView.class
)
public class CommerceDiscountOrderTypeClayTableDataSetDisplayView
