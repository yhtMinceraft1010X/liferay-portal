...
page import="com.liferay.commerce.order.rule.web.internal.frontend.constants.COREntryDataSetDisplayNames" %><%@
page import="com.liferay.commerce.order.rule.web.internal.frontend.taglib.servlet.taglib.constants.COREntryScreenNavigationEntryConstants" %><%@
