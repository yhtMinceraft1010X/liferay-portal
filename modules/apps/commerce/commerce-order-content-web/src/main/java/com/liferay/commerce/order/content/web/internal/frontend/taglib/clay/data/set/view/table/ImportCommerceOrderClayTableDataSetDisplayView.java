...
@Component(
	...
	property = "clay.data.set.display.name=" + CommerceOrderDataSetConstants.COMMERCE_DATA_SET_KEY_IMPORT_ORDERS,
	service = ClayDataSetDisplayView.class
)
public class ImportCommerceOrderClayTableDataSetDisplayView
