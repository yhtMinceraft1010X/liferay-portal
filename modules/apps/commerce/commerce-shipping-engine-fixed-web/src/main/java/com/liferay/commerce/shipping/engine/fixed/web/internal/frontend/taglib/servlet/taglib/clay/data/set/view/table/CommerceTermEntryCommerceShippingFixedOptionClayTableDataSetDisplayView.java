...
@Component(
	...
	property = "clay.data.set.display.name=" + CommerceShippingFixedOptionClayDataSetDisplayNames.COMMERCE_DATA_SET_KEY_COMMERCE_TERM_ENTRIES,
	service = ClayDataSetDisplayView.class
)
public class
	CommerceTermEntryCommerceShippingFixedOptionClayTableDataSetDisplayView
