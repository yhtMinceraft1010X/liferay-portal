...
@Component(
	...
	property = "clay.data.set.display.name=" + CommerceOrderDataSetConstants.COMMERCE_DATA_SET_KEY_ORDER_TYPE_QUALIFIER_CHANNELS,
	service = ClayDataSetDisplayView.class
)
public class CommerceOrderTypeChannelClayTableDataSetDisplayView
