...
@Component(
	...
	property = "clay.data.set.display.name=" + CommerceTaxRateSettingDataSetConstants.COMMERCE_DATA_SET_KEY_TAX_RATE_SETTING,
	service = ClayDataSetDisplayView.class
)
public class CommerceTaxRateSettingClayTableDataSetDisplayView
	...
	public ClayTableSchema getClayTableSchema() {
		...
		clayTableSchemaBuilder.addClayTableSchemaField("rate", "amount");
