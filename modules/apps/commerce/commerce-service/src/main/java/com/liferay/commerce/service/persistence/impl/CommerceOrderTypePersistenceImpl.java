...
public class CommerceOrderTypePersistenceImpl
	...
	public void afterPropertiesSet() {
		...
		_argumentsResolverServiceRegistration = _bundleContext.registerService(
			...
			new CommerceOrderTypeModelArgumentsResolver(),
	...
	private static class CommerceOrderTypeModelArgumentsResolver
		...
		public Object[] getArguments(
			...
			if (!checkColumn || (columnBitmask == 0)) {
				return _getValue(
					commerceOrderTypeModelImpl, columnNames, original);
			}
		...
		static {
			...
			orderByColumnsBitmask |=
				CommerceOrderTypeModelImpl.getColumnBitmask("createDate");
