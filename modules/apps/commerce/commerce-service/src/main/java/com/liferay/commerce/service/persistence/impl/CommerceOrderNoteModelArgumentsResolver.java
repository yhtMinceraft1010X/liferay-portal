...
/**
 * The arguments resolver class for retrieving value from CommerceOrderNote.
 *
 * @author Alessio Antonio Rendina
 * @generated
 */
public class CommerceOrderNoteModelArgumentsResolver
	...
	public Object[] getArguments(
		...
		if (!checkColumn || (columnBitmask == 0)) {
			return _getValue(commerceOrderNoteModelImpl, columnNames, original);
		}
		...
		if (finderPathColumnBitmask == null) {
			...
			if (finderPath.isBaseModelResult() &&
				(CommerceOrderNotePersistenceImpl.
	...
	static {
		...
		orderByColumnsBitmask |= CommerceOrderNoteModelImpl.getColumnBitmask(
			"createDate");
