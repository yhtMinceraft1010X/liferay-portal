...
public class CommerceOrderTypeRelPersistenceImpl
	...
	public void afterPropertiesSet() {
		...
		_argumentsResolverServiceRegistration = _bundleContext.registerService(
			...
			new CommerceOrderTypeRelModelArgumentsResolver(),
	...
	private static class CommerceOrderTypeRelModelArgumentsResolver
		...
		public Object[] getArguments(
			...
			long columnBitmask =
				commerceOrderTypeRelModelImpl.getColumnBitmask();
		...
		static {
			...
			orderByColumnsBitmask |=
				CommerceOrderTypeRelModelImpl.getColumnBitmask("createDate");
