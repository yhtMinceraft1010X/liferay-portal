...
/**
 * The base model interface for the CommerceOrderRuleEntryRel service. Represents a row in the &quot;CommerceOrderRuleEntryRel&quot; database table, with each column mapped to a property of this class.
 *
 * <p>
 * This interface and its corresponding implementation <code>com.liferay.commerce.order.rule.model.impl.CommerceOrderRuleEntryRelModelImpl</code> exist only as a container for the default property accessors generated by ServiceBuilder. Helper methods and all application logic should be put in <code>com.liferay.commerce.order.rule.model.impl.CommerceOrderRuleEntryRelImpl</code>.
 * </p>
 *
 ...
 */
@ProviderType
public interface CommerceOrderRuleEntryRelModel
	extends AttachedModel, AuditedModel, BaseModel<CommerceOrderRuleEntryRel>,
			ShardedModel {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. All methods that expect a commerce order rule entry rel model instance should use the {@link CommerceOrderRuleEntryRel} interface instead.
	 */
