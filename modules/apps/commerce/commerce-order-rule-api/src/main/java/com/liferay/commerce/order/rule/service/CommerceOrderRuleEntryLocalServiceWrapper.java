...
public class CommerceOrderRuleEntryLocalServiceWrapper
	...
	public java.util.List
		<com.liferay.commerce.order.rule.model.CommerceOrderRuleEntry>
			getAccountEntryCORuleEntries(long companyId, long accountEntryId) {

		return _commerceOrderRuleEntryLocalService.getAccountEntryCORuleEntries(
	...
	public java.util.List
		<com.liferay.commerce.order.rule.model.CommerceOrderRuleEntry>
			getAccountGroupsCORuleEntries(
				long companyId, long[] accountGroupIds) {

		return _commerceOrderRuleEntryLocalService.
			getAccountGroupsCORuleEntries(companyId, accountGroupIds);
	}
	...
	public java.util.List
		<com.liferay.commerce.order.rule.model.CommerceOrderRuleEntry>
			getCommerceChannelCORuleEntries(
				long companyId, long commerceChannelId) {

		return _commerceOrderRuleEntryLocalService.
			getCommerceChannelCORuleEntries(companyId, commerceChannelId);
	}
	...
	public java.util.List
		...
		return _commerceOrderRuleEntryLocalService.
			getCommerceOrderTypeCORuleEntries(companyId, commerceOrderTypeId);
	}
