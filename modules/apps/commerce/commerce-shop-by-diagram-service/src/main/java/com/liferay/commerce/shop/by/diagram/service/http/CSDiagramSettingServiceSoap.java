 ...
 * <code>com.liferay.commerce.shop.by.diagram.model.CSDiagramSettingSoap</code>. If the method in the
 * service utility returns a
 * <code>com.liferay.commerce.shop.by.diagram.model.CSDiagramSetting</code>, that is translated to a
 * <code>com.liferay.commerce.shop.by.diagram.model.CSDiagramSettingSoap</code>. Methods that SOAP
 ...
 * @see CSDiagramSettingServiceHttp
...
public class CSDiagramSettingServiceSoap {
	...
	public static
		com.liferay.commerce.shop.by.diagram.model.CSDiagramSettingSoap
				addCSDiagramSetting(
		...
		try {
			com.liferay.commerce.shop.by.diagram.model.CSDiagramSetting
				returnValue = CSDiagramSettingServiceUtil.addCSDiagramSetting(
					cpDefinitionId, cpAttachmentFileEntryId, color, radius,
					type);

			return com.liferay.commerce.shop.by.diagram.model.
				CSDiagramSettingSoap.toSoapModel(returnValue);
		}
	...
	public static
		...
		try {
			com.liferay.commerce.shop.by.diagram.model.CSDiagramSetting
				returnValue = CSDiagramSettingServiceUtil.getCSDiagramSetting(
					csDiagramSettingId);
	...
	public static
		...
		try {
			com.liferay.commerce.shop.by.diagram.model.CSDiagramSetting
				returnValue =
					CSDiagramSettingServiceUtil.updateCSDiagramSetting(
						csDiagramSettingId, cpAttachmentFileEntryId, color,
						radius, type);
	...
	private static Log _log = LogFactoryUtil.getLog(
		CSDiagramSettingServiceSoap.class);
