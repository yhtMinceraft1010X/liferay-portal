...
/**
 * The arguments resolver class for retrieving value from BatchPlannerPolicy.
 *
 * @author Igor Beslic
 * @generated
 */
@Component(
	immediate = true,
	service = {
		BatchPlannerPolicyModelArgumentsResolver.class, ArgumentsResolver.class
	}
)
public class BatchPlannerPolicyModelArgumentsResolver
		...
		if (finderPathColumnBitmask == null) {
			...
			for (String columnName : columnNames) {
				finderPathColumnBitmask |=
					batchPlannerPolicyModelImpl.getColumnBitmask(columnName);
			}

			if (finderPath.isBaseModelResult() &&
				(BatchPlannerPolicyPersistenceImpl.
	...
	static {
		...
		orderByColumnsBitmask |= BatchPlannerPolicyModelImpl.getColumnBitmask(
			"modifiedDate");
