...
/**
 * The arguments resolver class for retrieving value from BatchPlannerMapping.
 *
 * @author Igor Beslic
 * @generated
 */
...
public class BatchPlannerMappingModelArgumentsResolver
	...
	public Object[] getArguments(
		...
		long columnBitmask = batchPlannerMappingModelImpl.getColumnBitmask();
		...
		if (finderPathColumnBitmask == null) {
			...
			for (String columnName : columnNames) {
				finderPathColumnBitmask |=
					batchPlannerMappingModelImpl.getColumnBitmask(columnName);
			}

			if (finderPath.isBaseModelResult() &&
				(BatchPlannerMappingPersistenceImpl.
	...
	static {
		...
		orderByColumnsBitmask |= BatchPlannerMappingModelImpl.getColumnBitmask(
			"modifiedDate");
