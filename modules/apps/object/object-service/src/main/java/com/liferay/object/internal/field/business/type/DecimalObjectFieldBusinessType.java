...
@Component(
	immediate = true,
	property = "object.field.business.type.name=" + ObjectFieldTypeConstants.BUSINESS_TYPE_DECIMAL,
	service = {
...
public class DecimalObjectFieldBusinessType implements ObjectFieldBusinessType {
	...
	public String getDBType() {
		return ObjectFieldTypeConstants.DB_TYPE_DOUBLE;
	}
	...
	public String getName() {
		return ObjectFieldTypeConstants.BUSINESS_TYPE_DECIMAL;
	}
