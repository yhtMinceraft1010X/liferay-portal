...
@Component(
	immediate = true,
	property = "object.field.business.type.name=" + ObjectFieldTypeConstants.BUSINESS_TYPE_INTEGER,
	service = {
...
public class IntegerObjectFieldBusinessType implements ObjectFieldBusinessType {
	...
	public String getDBType() {
		return ObjectFieldTypeConstants.DB_TYPE_INTEGER;
	}
	...
	public String getName() {
		return ObjectFieldTypeConstants.BUSINESS_TYPE_INTEGER;
	}
