...
/**
 * Provides the local service interface for ObjectLayoutBoxRow. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Marco Leo
 * @see ObjectLayoutBoxRowLocalServiceUtil
 * @generated
 */
@ProviderType
@Transactional(
...
public interface ObjectLayoutBoxRowLocalService
	...
	public ObjectLayoutBoxRow createObjectLayoutBoxRow(
	...
	public ObjectLayoutBoxRow deleteObjectLayoutBoxRow(
			long objectLayoutBoxRowId)
		throws PortalException;
	...
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public ObjectLayoutBoxRow fetchObjectLayoutBoxRow(
		long objectLayoutBoxRowId);
	 ...
	 */
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public ObjectLayoutBoxRow fetchObjectLayoutBoxRowByUuidAndCompanyId(
	 ...
	 */
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public ObjectLayoutBoxRow getObjectLayoutBoxRow(long objectLayoutBoxRowId)
		throws PortalException;
	 ...
	 */
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public ObjectLayoutBoxRow getObjectLayoutBoxRowByUuidAndCompanyId(
			String uuid, long companyId)
		throws PortalException;
	 ...
	 */
	@Indexable(type = IndexableType.REINDEX)
	public ObjectLayoutBoxRow updateObjectLayoutBoxRow(
		ObjectLayoutBoxRow objectLayoutBoxRow);
