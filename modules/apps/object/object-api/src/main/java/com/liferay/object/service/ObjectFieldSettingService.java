...
/**
 * Provides the remote service interface for ObjectFieldSetting. Methods of this
 * service are expected to have security checks based on the propagated JAAS
 * credentials because this service can be accessed remotely.
 *
 * @author Marco Leo
 * @see ObjectFieldSettingServiceUtil
 * @generated
 */
@AccessControlled
@JSONWebService
...
public interface ObjectFieldSettingService extends BaseService {
