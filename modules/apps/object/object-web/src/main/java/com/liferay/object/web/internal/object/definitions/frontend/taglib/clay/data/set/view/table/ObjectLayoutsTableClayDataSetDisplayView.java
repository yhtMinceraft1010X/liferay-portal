 ...
 */
@Component(
	property = "clay.data.set.display.name=" + ObjectDefinitionsClayDataSetDisplayNames.OBJECT_LAYOUTS,
	service = ClayDataSetDisplayView.class
)
public class ObjectLayoutsTableClayDataSetDisplayView
	...
	public ClayTableSchema getClayTableSchema() {
		...
		ClayTableSchemaField defaultObjectLayoutClayTableSchemaField =
			clayTableSchemaBuilder.addClayTableSchemaField(
				"defaultObjectLayout", "default");

		defaultObjectLayoutClayTableSchemaField.setContentRenderer("boolean");
