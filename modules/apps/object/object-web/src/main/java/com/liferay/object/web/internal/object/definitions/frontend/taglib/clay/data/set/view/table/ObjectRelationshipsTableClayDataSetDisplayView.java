 ...
 */
@Component(
	property = "clay.data.set.display.name=" + ObjectDefinitionsClayDataSetDisplayNames.OBJECT_RELATIONSHIPS,
	service = ClayDataSetDisplayView.class
)
public class ObjectRelationshipsTableClayDataSetDisplayView
