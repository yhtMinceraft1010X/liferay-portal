...
public class ObjectEntryMtoMObjectRelatedModelsProviderTest {
	...
	@Test
	public void testCustomObjectsManyToManyRelationship() throws Exception {
		ObjectRelatedModelsProvider<ObjectEntry> relationshipDataProvider =
		...
		ObjectRelationshipLocalServiceUtil.addObjectRelationshipMapEntry(
			_objectRelationship.getObjectRelationshipId(),
			leftObjectEntry.getObjectEntryId(),
			rightObjectEntry.getObjectEntryId());

		List<ObjectEntry> relatedEntities =
			relationshipDataProvider.getRelatedModels(
		...
		rightObjectEntry = ObjectEntryLocalServiceUtil.addObjectEntry(
			TestPropsValues.getUserId(), 0,
			_objectDefinition2.getObjectDefinitionId(),
			HashMapBuilder.<String, Serializable>put(
				"random", RandomTestUtil.randomString()
		...
		relatedEntities = relationshipDataProvider.getRelatedModels(
			0, leftObjectEntry.getObjectEntryId(),
