...
package com.liferay.friendly.url.change.tracking.test;
...
public class FriendlyURLEntryTableReferenceDefinitionTest
	...
	protected CTModel<?> addCTModel() throws Exception {
		return _friendlyURLEntryLocalService.addFriendlyURLEntry(
			...
			Collections.singletonMap("en", "url-title-en"),
