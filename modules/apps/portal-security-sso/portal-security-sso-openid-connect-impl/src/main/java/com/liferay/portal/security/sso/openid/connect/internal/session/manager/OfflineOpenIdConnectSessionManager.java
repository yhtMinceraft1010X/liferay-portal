...
public class OfflineOpenIdConnectSessionManager {
	...
	public static void extendOpenIdConnectSession(
		long loginTime, OIDCTokens oidcTokens,
	...
	public static void startOpenIdConnectSession(
		HttpSession httpSession, long loginTime, OIDCTokens oidcTokens,
		OpenIdConnectSessionImpl openIdConnectSessionImpl, long userId,
		UserInfo userInfo) {
		...
		extendOpenIdConnectSession(
			loginTime, oidcTokens, openIdConnectSessionImpl);
