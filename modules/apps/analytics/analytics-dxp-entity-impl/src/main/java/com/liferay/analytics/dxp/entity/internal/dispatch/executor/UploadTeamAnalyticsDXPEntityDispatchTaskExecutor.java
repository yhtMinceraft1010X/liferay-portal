...
@Component(
	immediate = true,
	property = {
		"dispatch.task.executor.name=" + UploadTeamAnalyticsDXPEntityDispatchTaskExecutor.KEY,
		"dispatch.task.executor.type=" + UploadTeamAnalyticsDXPEntityDispatchTaskExecutor.KEY
	},
	service = DispatchTaskExecutor.class
)
public class UploadTeamAnalyticsDXPEntityDispatchTaskExecutor
	extends BaseDispatchTaskExecutor {

	public static final String KEY = "upload-team-analytics-dxp-entities";
	...
	public void doExecute(
		...
		_uploadAnalyticsDXPEntityDispatchTaskExecutorHelper.doExecute(
			"team-analytics-dxp-entities", dispatchTrigger,
