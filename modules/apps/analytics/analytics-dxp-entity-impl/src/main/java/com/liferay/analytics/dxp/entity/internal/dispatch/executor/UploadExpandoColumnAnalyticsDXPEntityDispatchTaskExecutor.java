...
@Component(
	immediate = true,
	property = {
		"dispatch.task.executor.name=" + UploadExpandoColumnAnalyticsDXPEntityDispatchTaskExecutor.KEY,
		"dispatch.task.executor.type=" + UploadExpandoColumnAnalyticsDXPEntityDispatchTaskExecutor.KEY
	},
	service = DispatchTaskExecutor.class
)
public class UploadExpandoColumnAnalyticsDXPEntityDispatchTaskExecutor
	...
	public void doExecute(
		...
		_uploadAnalyticsDXPEntityDispatchTaskExecutorHelper.doExecute(
			"expando-column-analytics-dxp-entities", dispatchTrigger,
