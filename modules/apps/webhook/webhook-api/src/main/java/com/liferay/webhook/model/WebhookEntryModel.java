...
/**
 * The base model interface for the WebhookEntry service. Represents a row in the &quot;WebhookEntry&quot; database table, with each column mapped to a property of this class.
 *
 * <p>
 * This interface and its corresponding implementation <code>com.liferay.webhook.model.impl.WebhookEntryModelImpl</code> exist only as a container for the default property accessors generated by ServiceBuilder. Helper methods and all application logic should be put in <code>com.liferay.webhook.model.impl.WebhookEntryImpl</code>.
 * </p>
 *
 ...
 */
@ProviderType
public interface WebhookEntryModel
	extends BaseModel<WebhookEntry>, MVCCModel, ShardedModel,
			StagedAuditedModel {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. All methods that expect a webhook entry model instance should use the {@link WebhookEntry} interface instead.
	 */
