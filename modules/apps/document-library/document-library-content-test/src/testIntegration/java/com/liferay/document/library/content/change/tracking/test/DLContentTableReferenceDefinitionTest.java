...
package com.liferay.document.library.content.change.tracking.test;
...
public class DLContentTableReferenceDefinitionTest
	...
	protected CTModel<?> addCTModel() {
		String path = DLContentTableReferenceDefinitionTest.class.getName();

		return _dlContentLocalService.addContent(
			group.getCompanyId(), RandomTestUtil.nextLong(), path,
