...
@Component(
	...
	property = {
		...
		"javax.portlet.init-param.mvc-command-names-default-views=/custom_elements_portlet_descriptor/view",
...
public class CustomElementsPortletDescriptorPortlet extends MVCPortlet {
}