...
public class CustomElementsPortletDescriptorClayDataSetActionProvider
	...
	public List<DropdownItem> getDropdownItems(
		...
		CustomElementsPortletDescriptorClayDataSetEntry
			customElementsPortletDescriptorClayDataSetEntry =
				(CustomElementsPortletDescriptorClayDataSetEntry)model;
			...
			dropdownItem -> {
				...
				dropdownItem.setHref(
					PortletURLBuilder.create(
						...
						"/custom_elements_portlet_descriptor" +
							"/delete_custom_elements_portlet_descriptor"
					).setParameter(
						"customElementsPortletDescriptorId",
						customElementsPortletDescriptorClayDataSetEntry.
							getCustomElementsPortletDescriptorId()
