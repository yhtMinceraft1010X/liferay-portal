...
String viewInContextURL = assetRenderer.getURLViewInContext(liferayPortletRequest, liferayPortletResponse, HttpHelperUtil.setParameter(viewFullContentURL.toString(), "redirect", currentURL));
