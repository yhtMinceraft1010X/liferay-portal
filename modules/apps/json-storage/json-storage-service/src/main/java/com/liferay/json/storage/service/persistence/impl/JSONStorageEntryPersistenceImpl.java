...
public class JSONStorageEntryPersistenceImpl
	...
	public void activate(BundleContext bundleContext) {
		...
		_argumentsResolverServiceRegistration = _bundleContext.registerService(
			...
			new JSONStorageEntryModelArgumentsResolver(),
	...
	private static class JSONStorageEntryModelArgumentsResolver
		...
		public Object[] getArguments(
			...
			if (!checkColumn || (columnBitmask == 0)) {
				return _getValue(
					jsonStorageEntryModelImpl, columnNames, original);
			}
		...
		private static Object[] _getValue(
			...
			for (int i = 0; i < arguments.length; i++) {
				...
				if (original) {
					arguments[i] =
						jsonStorageEntryModelImpl.getColumnOriginalValue(
							columnName);
				}
				else {
