 ...
 */
public class DuplicateArticleExternalReferenceCodeException extends PortalException {
	...
	public DuplicateArticleExternalReferenceCodeException(String msg, Throwable throwable) {
		super(msg, throwable);
	}
