...
/**
 * The arguments resolver class for retrieving value from JournalArticle.
 *
...
@Component(
	immediate = true,
	service = {
		JournalArticleModelArgumentsResolver.class, ArgumentsResolver.class
	}
)
public class JournalArticleModelArgumentsResolver implements ArgumentsResolver {
	...
	public Object[] getArguments(
		...
		JournalArticleModelImpl journalArticleModelImpl =
			(JournalArticleModelImpl)baseModel;
	...
	public String getClassName() {
		return JournalArticleImpl.class.getName();
	}

	@Override
	public String getTableName() {
		return JournalArticleTable.INSTANCE.getTableName();
	}
