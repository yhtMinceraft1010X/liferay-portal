	...
	<aui:form action="<%= updateKBArticleURL %>" method="post" name="fm">
		...
		<div class="lfr-form-content">
			...
			<liferay-ui:error exception="<%= FileSizeException.class %>">
				<liferay-ui:message arguments="<%= DLValidatorUtil.getMaxAllowableSize(null) / 1024 %>" key="please-enter-a-file-with-a-valid-file-size-no-larger-than-x" translateArguments="<%= false %>" />
			</liferay-ui:error>
