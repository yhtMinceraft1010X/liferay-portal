...
create unique index IX_A358F410 on KBArticle (groupId, externalReferenceCode[$COLUMN_LENGTH:75$], version);
...
create unique index IX_1638507E on KBFolder (groupId, externalReferenceCode[$COLUMN_LENGTH:75$]);
