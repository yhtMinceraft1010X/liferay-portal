...
>
	...
	<c:if test="<%= portletName.equals(AccountPortletKeys.ACCOUNT_ENTRIES_MANAGEMENT) && (accountEntryId != CurrentAccountEntryManagerUtil.getCurrentAccountEntryId(themeDisplay.getScopeGroupId(), user.getUserId())) %>">
