...
/**
 * The implementation of the batch engine import task remote service.
 *
 * <p>
 * All custom service methods should be put in this class. Whenever methods are added, rerun ServiceBuilder to copy their definitions into the <code>com.liferay.batch.engine.service.BatchEngineImportTaskService</code> interface.
 *
 * <p>
 ...
 *
 * @author Shuyang Zhou
 * @see BatchEngineImportTaskServiceBaseImpl
 */
@Component(
	property = {
