...
@Generated("")
@GraphQLName(
	description = "The organization's account information.",
...
public class AccountInformation implements Serializable {
	...
	public static AccountInformation toDTO(String json) {
		return ObjectMapperUtil.readValue(AccountInformation.class, json);
	}

	@Schema(
		description = "The list of Accounts associated with the organization."
	)
	@Valid
	...
	@Schema(
		description = "The count of Accounts associated with the organization."
	)
	...
	@Schema(
		...
		defaultValue = "com.liferay.headless.admin.user.dto.v1_0.AccountInformation",
		name = "x-class-name"
	)
