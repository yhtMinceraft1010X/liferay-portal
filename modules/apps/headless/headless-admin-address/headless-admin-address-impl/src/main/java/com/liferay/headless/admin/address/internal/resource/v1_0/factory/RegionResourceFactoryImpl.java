...
public class RegionResourceFactoryImpl implements RegionResource.Factory {
	...
	@Override
	public RegionResource.Builder create() {
		return new RegionResource.Builder() {
			...
			@Override
			public RegionResource.Builder checkPermissions(
			...
			@Override
			public RegionResource.Builder httpServletRequest(
			...
			@Override
			public RegionResource.Builder httpServletResponse(
			...
			@Override
			public RegionResource.Builder preferredLocale(
			...
			@Override
			public RegionResource.Builder user(User user) {
				_user = user;
	...
	private static Function<InvocationHandler, RegionResource>
		...
		Class<?> proxyClass = ProxyUtil.getProxyClass(
			RegionResource.class.getClassLoader(), RegionResource.class);

		try {
			Constructor<RegionResource> constructor =
				(Constructor<RegionResource>)proxyClass.getConstructor(
	...
	private Object _invoke(
		...
		try {
			...
			_componentServiceObjects.ungetService(regionResource);
	...
	private ComponentServiceObjects<RegionResource> _componentServiceObjects;
