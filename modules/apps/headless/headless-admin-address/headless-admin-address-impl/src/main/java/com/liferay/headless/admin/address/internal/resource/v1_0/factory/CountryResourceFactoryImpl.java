...
public class CountryResourceFactoryImpl implements CountryResource.Factory {
	...
	@Override
	public CountryResource.Builder create() {
		return new CountryResource.Builder() {
			...
			public CountryResource build() {
				...
				return _countryResourceProxyProviderFunction.apply(
			...
			@Override
			public CountryResource.Builder checkPermissions(
			...
			@Override
			public CountryResource.Builder httpServletRequest(
			...
			@Override
			public CountryResource.Builder httpServletResponse(
			...
			@Override
			public CountryResource.Builder preferredLocale(
			...
			@Override
			public CountryResource.Builder user(User user) {
				_user = user;
	...
	protected void activate() {
		CountryResource.FactoryHolder.factory = this;
	}

	@Deactivate
	protected void deactivate() {
		CountryResource.FactoryHolder.factory = null;
	}

	private static Function<InvocationHandler, CountryResource>
		_getProxyProviderFunction() {

		Class<?> proxyClass = ProxyUtil.getProxyClass(
			CountryResource.class.getClassLoader(), CountryResource.class);

		try {
			Constructor<CountryResource> constructor =
				(Constructor<CountryResource>)proxyClass.getConstructor(
	...
	private Object _invoke(
		...
		try {
			...
			_componentServiceObjects.ungetService(countryResource);
	...
	private static final Function<InvocationHandler, CountryResource>
		_countryResourceProxyProviderFunction = _getProxyProviderFunction();

	@Reference
	private CompanyLocalService _companyLocalService;

	@Reference(scope = ReferenceScope.PROTOTYPE_REQUIRED)
	private ComponentServiceObjects<CountryResource> _componentServiceObjects;
