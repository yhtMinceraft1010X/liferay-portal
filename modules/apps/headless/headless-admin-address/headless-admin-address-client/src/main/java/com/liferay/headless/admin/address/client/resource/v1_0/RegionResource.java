...
public interface RegionResource {
	...
	public HttpInvoker.HttpResponse postRegionHttpResponse(Region region)
		throws Exception;

	public void postRegionBatch(String callbackURL, Object object)
		throws Exception;

	public HttpInvoker.HttpResponse postRegionBatchHttpResponse(
	...
	public static class RegionResourceImpl implements RegionResource {
		...
		public Region postRegion(Region region) throws Exception {
			HttpInvoker.HttpResponse httpResponse = postRegionHttpResponse(
				region);
		...
		public void postRegionBatch(String callbackURL, Object object)
			...
			HttpInvoker.HttpResponse httpResponse = postRegionBatchHttpResponse(
				callbackURL, object);
