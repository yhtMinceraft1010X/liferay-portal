...
/**
 * The arguments resolver class for retrieving value from Account.
 *
...
@Component(
	immediate = true,
	service = {AccountModelArgumentsResolver.class, ArgumentsResolver.class}
)
public class AccountModelArgumentsResolver implements ArgumentsResolver {
	...
	static {
		...
		orderByColumnsBitmask |= AccountModelImpl.getColumnBitmask("address");
