...
/**
 * The arguments resolver class for retrieving value from WeDeployAuthToken.
 *
...
@Component(
	immediate = true,
	service = {
		WeDeployAuthTokenModelArgumentsResolver.class, ArgumentsResolver.class
	}
)
public class WeDeployAuthTokenModelArgumentsResolver
	...
	public Object[] getArguments(
		...
		if (!checkColumn || (columnBitmask == 0)) {
			return _getValue(weDeployAuthTokenModelImpl, columnNames, original);
		}
