...
/**
 * The arguments resolver class for retrieving value from Status.
 *
...
@Component(
	immediate = true,
	service = {StatusModelArgumentsResolver.class, ArgumentsResolver.class}
)
public class StatusModelArgumentsResolver implements ArgumentsResolver {
