...
/**
 * The arguments resolver class for retrieving value from DLFileRank.
 *
...
@Component(
	immediate = true,
	service = {DLFileRankModelArgumentsResolver.class, ArgumentsResolver.class}
)
public class DLFileRankModelArgumentsResolver implements ArgumentsResolver {
	...
	private static Object[] _getValue(
		...
		for (int i = 0; i < arguments.length; i++) {
			...
			if (original) {
				...
				arguments[i] = dlFileRankModelImpl.getColumnValue(columnName);
			}
		}
