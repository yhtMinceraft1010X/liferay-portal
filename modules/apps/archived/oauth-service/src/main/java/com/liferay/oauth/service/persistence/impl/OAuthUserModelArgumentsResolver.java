...
/**
 * The arguments resolver class for retrieving value from OAuthUser.
 *
 * @author Ivica Cardic
 * @generated
 */
@Component(
	immediate = true,
	service = {OAuthUserModelArgumentsResolver.class, ArgumentsResolver.class}
)
public class OAuthUserModelArgumentsResolver implements ArgumentsResolver {
	...
	private static Object[] _getValue(
		...
		for (int i = 0; i < arguments.length; i++) {
			...
			if (original) {
				...
				arguments[i] = oAuthUserModelImpl.getColumnValue(columnName);
			}
		}
