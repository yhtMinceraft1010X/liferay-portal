...
public class CalendarTableReferenceDefinitionTest
	...
	public void setUp() throws Exception {
		...
		_calendarResource = CalendarResourceTestUtil.addCalendarResource(group);
	}

	@Override
	protected CTModel<?> addCTModel() throws Exception {
		return CalendarTestUtil.addCalendar(
			_calendarResource,
