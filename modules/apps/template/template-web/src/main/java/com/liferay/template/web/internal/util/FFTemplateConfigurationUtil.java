 ...
 */
@Component(
	configurationPid = "com.liferay.template.web.internal.configuration.FFTemplateConfiguration",
...
public class FFTemplateConfigurationUtil {
	...
	protected void activate(Map<String, Object> properties) {
		_ffTemplateConfiguration = ConfigurableUtil.createConfigurable(
			FFTemplateConfiguration.class, properties);
	}
