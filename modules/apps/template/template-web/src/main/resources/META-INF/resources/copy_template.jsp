...
long ddmTemplateId = ParamUtil.getLong(request, "templateId");
...
<portlet:actionURL name="/template/copy_template" var="copyTemplateURL">
...
>
	...
	<aui:input name="templateId" type="hidden" value="<%= ddmTemplateId %>" />
