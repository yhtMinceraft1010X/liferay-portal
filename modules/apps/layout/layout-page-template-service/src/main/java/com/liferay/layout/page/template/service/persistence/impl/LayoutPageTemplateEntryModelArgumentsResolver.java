...
/**
 * The arguments resolver class for retrieving value from LayoutPageTemplateEntry.
 *
...
@Component(
	immediate = true,
	service = {
		LayoutPageTemplateEntryModelArgumentsResolver.class,
		ArgumentsResolver.class
	}
)
public class LayoutPageTemplateEntryModelArgumentsResolver
	...
	public Object[] getArguments(
		...
		if (finderPathColumnBitmask == null) {
			...
			if (finderPath.isBaseModelResult() &&
				(LayoutPageTemplateEntryPersistenceImpl.
	...
	private static Object[] _getValue(
		...
		for (int i = 0; i < arguments.length; i++) {
			...
			if (original) {
				...
				arguments[i] = layoutPageTemplateEntryModelImpl.getColumnValue(
					columnName);
			}
		}
