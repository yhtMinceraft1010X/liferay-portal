...
<c:choose>
	...
	<c:otherwise>
		...
		<aui:form action='<%= HttpHelperUtil.addParameter(editLayoutURL, "refererPlid", plid) %>' enctype="multipart/form-data" method="post" name="editLayoutFm" onSubmit="event.preventDefault();">
