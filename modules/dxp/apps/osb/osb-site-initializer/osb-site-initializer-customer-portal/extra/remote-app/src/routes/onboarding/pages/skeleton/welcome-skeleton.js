...
const WelcomeSkeleton = () => {
  return (
    <Layout
      footerProps={{
        middleButton: (
          <RoundedSkeleton height={48} width={110} />
        ),
      }}
      headerSkeleton={<div className="p-4">
    ...
    >
      ...
      <TextSkeleton align="center" className="d-flex flex-column justify-content-center my-auto" count={2} height={8} width={400} />
    </Layout>
  );
};
