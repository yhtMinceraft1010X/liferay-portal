 ...
 */
@Generated("")
public class SXPElement implements Cloneable, Serializable {

	public static SXPElement toDTO(String json) {
		return SXPElementSerDes.toDTO(json);
	}
	...
	public String toString() {
		return SXPElementSerDes.toJSON(this);
	}
