...
public interface SXPBlueprintResource {
	...
	public static class SXPBlueprintResourceImpl
		...
		public String getSXPBlueprintExport(Long sxpBlueprintId)
			throws Exception {
		...
		public HttpInvoker.HttpResponse getSXPBlueprintExportHttpResponse(
			...
			if (sxpBlueprintId != null) {
				httpInvoker.parameter(
					"sxpBlueprintId", String.valueOf(sxpBlueprintId));
			}

			httpInvoker.path(
				_builder._scheme + "://" + _builder._host + ":" +
					_builder._port +
						"/o/search-experiences-rest/v1.0/sxp-blueprints/export");
