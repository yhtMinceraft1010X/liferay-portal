	...
	public static class SXPBlueprintResourceImpl
		...
		public HttpInvoker.HttpResponse deleteSXPBlueprintHttpResponse(
			...
			httpInvoker.path(
				_builder._scheme + "://" + _builder._host + ":" +
					_builder._port +
						"/o/search-experiences-rest/v1.0/sxp-blueprint/{sxpBlueprintId}");
		...
		public HttpInvoker.HttpResponse deleteSXPBlueprintBatchHttpResponse(
			...
			httpInvoker.path(
				_builder._scheme + "://" + _builder._host + ":" +
					_builder._port +
						"/o/search-experiences-rest/v1.0/sxp-blueprint/{sxpBlueprintId}/batch");
		...
		public Page<SXPBlueprint> getSXPBlueprintsPage(Pagination pagination)
			...
			HttpInvoker.HttpResponse httpResponse =
				getSXPBlueprintsPageHttpResponse(pagination);
