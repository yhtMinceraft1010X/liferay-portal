...
public abstract class BaseSearchResponseResourceImpl
	 ...
	 *
	 * curl -X 'POST' 'http://localhost:8080/o/search-experiences-rest/v1.0/search' -d $'{"configuration": ___, "description": ___, "description_i18n": ___, "id": ___, "title": ___, "title_i18n": ___}' --header 'Content-Type: application/json' -u 'test@liferay.com:test'
	 */
