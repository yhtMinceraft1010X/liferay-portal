...
public class SXPElementModelResourcePermissionRegistrar {

	@Activate
	protected void activate(BundleContext bundleContext) {
		_serviceRegistration = bundleContext.registerService(
			(Class<ModelResourcePermission<SXPElement>>)
				(Class<?>)ModelResourcePermission.class,
			ModelResourcePermissionFactory.create(
				SXPElement.class, SXPElement::getSXPElementId,
	...
	private ServiceRegistration<ModelResourcePermission<SXPElement>>
