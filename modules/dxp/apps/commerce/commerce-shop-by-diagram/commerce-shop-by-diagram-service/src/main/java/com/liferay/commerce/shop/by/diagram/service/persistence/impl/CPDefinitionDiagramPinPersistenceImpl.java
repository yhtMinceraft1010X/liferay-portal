...
public class CPDefinitionDiagramPinPersistenceImpl
	...
	public void activate(BundleContext bundleContext) {
		...
		_argumentsResolverServiceRegistration = _bundleContext.registerService(
			...
			new CPDefinitionDiagramPinModelArgumentsResolver(),
	...
	private static class CPDefinitionDiagramPinModelArgumentsResolver
		...
		private static Object[] _getValue(
			...
			for (int i = 0; i < arguments.length; i++) {
				...
				if (original) {
					...
					arguments[i] =
						cpDefinitionDiagramPinModelImpl.getColumnValue(
							columnName);
				}
			}
