...
public class Pin implements Serializable {
	...
	@Schema
	@Valid
	public DiagramEntry getDiagramEntry() {
		return diagramEntry;
	}

	public void setDiagramEntry(DiagramEntry diagramEntry) {
		this.diagramEntry = diagramEntry;
	}

	@JsonIgnore
	public void setDiagramEntry(
		UnsafeSupplier<DiagramEntry, Exception> diagramEntryUnsafeSupplier) {

		try {
			diagramEntry = diagramEntryUnsafeSupplier.get();
		}
	...
	protected DiagramEntry diagramEntry;
	...
	public String toString() {
		...
		if (diagramEntry != null) {
			...
			sb.append("\"diagramEntry\": ");

			sb.append(String.valueOf(diagramEntry));
		}
	...
	@Schema(
		...
		defaultValue = "com.liferay.headless.commerce.shop.by.diagram.dto.v1_0.Pin",
		name = "x-class-name"
	)
