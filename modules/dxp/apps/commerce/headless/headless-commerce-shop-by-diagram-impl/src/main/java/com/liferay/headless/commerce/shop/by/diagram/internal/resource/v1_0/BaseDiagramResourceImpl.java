...
public abstract class BaseDiagramResourceImpl
	 ...
	 *
	 * curl -X 'GET' 'http://localhost:8080/o/headless-commerce-shop-by-diagram/v1.0/products/by-externalReferenceCode/{externalReferenceCode}/diagrams'  -u 'test@liferay.com:test'
	 */
	@GET
	@Override
	@Parameters(
	 ...
	 * Invoke this method with the command line:
	 *
	 * curl -X 'PUT' 'http://localhost:8080/o/headless-commerce-shop-by-diagram/v1.0/products/by-externalReferenceCode/{externalReferenceCode}/diagrams' -d $'{"color": ___, "diagramEntries": ___, "id": ___, "imageId": ___, "imageURL": ___, "pins": ___, "radius": ___, "type": ___}' --header 'Content-Type: application/json' -u 'test@liferay.com:test'
	 */
	 ...
	 * Invoke this method with the command line:
	 *
	 * curl -X 'GET' 'http://localhost:8080/o/headless-commerce-shop-by-diagram/v1.0/products/{productId}/diagrams'  -u 'test@liferay.com:test'
	 */
	@GET
	@Override
	 ...
	 * Invoke this method with the command line:
	 *
	 * curl -X 'PUT' 'http://localhost:8080/o/headless-commerce-shop-by-diagram/v1.0/products/{productId}/diagrams' -d $'{"color": ___, "diagramEntries": ___, "id": ___, "imageId": ___, "imageURL": ___, "pins": ___, "radius": ___, "type": ___}' --header 'Content-Type: application/json' -u 'test@liferay.com:test'
	 */
	@Consumes({"application/json", "application/xml"})
	@Override
	@Parameters(value = {@Parameter(in = ParameterIn.PATH, name = "productId")})
