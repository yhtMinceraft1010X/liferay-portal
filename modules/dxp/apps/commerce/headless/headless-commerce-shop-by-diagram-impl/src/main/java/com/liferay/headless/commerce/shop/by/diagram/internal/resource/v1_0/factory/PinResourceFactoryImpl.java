...
package com.liferay.headless.commerce.shop.by.diagram.internal.resource.v1_0.factory;
	...
	public PinResource.Builder create() {
		return new PinResource.Builder() {
			...
			public PinResource build() {
				...
				return (PinResource)ProxyUtil.newProxyInstance(
					PinResource.class.getClassLoader(),
					new Class<?>[] {PinResource.class},
