			...
			<ul class="list-unstyled">
				...
				%>
					...
					<li class="lfr-api-signature <%= serviceSignature.equals(signature) ? "border border-primary my-2 rounded selected" : StringPool.BLANK %>">
						<a class="d-block lfr-api-service-result method-name px-2 py-1 rounded" data-metaData="<%= jsonWebServiceClassName %>" href="<%= HttpHelperUtil.addParameter(jsonWSContextPath, "signature", serviceSignature) %>">
							<%= path %>
						</a>
					</li>
